...
public class CardResponse {
    ...
    static {
        RESPONSE_MAP.put(LoginState.NEW, "Thank you, your {brandName} code is {myZappiCode}. Please enter this code on https://myzappiunofficial.com with your API key and serial number.");
        ...
        RESPONSE_MAP.put(UserNotLoggedInException.class, "You are not logged in. When you have your myenergi Zappi serial number and API key ready, ask me to login.");
