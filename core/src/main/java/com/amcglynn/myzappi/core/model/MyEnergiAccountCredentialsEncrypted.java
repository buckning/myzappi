...
@Getter
public class MyEnergiAccountCredentialsEncrypted {
     ...
     */
    public MyEnergiAccountCredentialsEncrypted(String userId, ByteBuffer encryptedEmailAddress, ByteBuffer encryptedPassword) {
        this.userId = userId;
